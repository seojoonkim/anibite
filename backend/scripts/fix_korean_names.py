...
Updates existing data and recreates triggers to use name_korean instead of name_native
"""
import sys
import os
...
def fix_korean_names():
    """Update existing data and recreate triggers"""

    print("Fixing Korean character names in activities...")
    print()

    # Step 1: Drop old triggers
    print("Step 1: Dropping old triggers...")
    triggers_to_drop = [
    ...
    # Step 2: Update existing data - character ratings
    print("Step 2: Updating existing character rating activities...")
    update_query = """
    UPDATE activities
    ...
    # Step 3: Recreate triggers with correct field
    print("Step 3: Recreating triggers with name_korean...")
