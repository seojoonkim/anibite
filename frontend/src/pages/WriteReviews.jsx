          ...
          <div className="flex gap-2 w-fit">
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${filter === 'all'
                ? 'bg-[#4EEAF7] text-white font-semibold'
                      ...
                      <div className="flex-1 min-w-0 p-6 flex flex-col transition-all duration-500 ease-in-out">
                        ...
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-semibold text-lg">
                            <Link
                              to={item.type === 'anime' ? `/anime/${item.itemId}` : `/character/${item.itemId}`}
                              className="text-gray-900 hover:text-[#4EEAF7] transition-colors hover:underline cursor-pointer"
                            >
                              {item.type === 'anime' ? (
                                language === 'ko' ? (
                                  <span>
                          ...
                          <p className="text-xs text-gray-500 mb-1">
                            ...
                            {item.anime_id ? (
                              <Link
                                ...
                                className="hover:text-[#4EEAF7] hover:underline transition-colors"
                              >
                                {language === 'ko' ? (
                                  <>
                            ...
                            {hasReview ? (
                              <>
                                ...
                                <button
                                  ...
                                  className="text-sm text-[#4EEAF7] hover:text-[#2DD4E4]"
                                >
                          ...
                          <div className="space-y-3 animate-fadeIn">
                            ...
                            <div className="flex gap-2">
                              <button
                                ...
                                style={{ backgroundColor: '#4EEAF7', color: 'white', fontWeight: '600' }}
                                onMouseEnter={(e) => !e.target.disabled && (e.target.style.backgroundColor = '#1877F2')}
                                onMouseLeave={(e) => !e.target.disabled && (e.target.style.backgroundColor = '#4EEAF7')}
                              >
