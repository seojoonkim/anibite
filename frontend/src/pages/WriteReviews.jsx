...
export default function WriteReviews() {
  ...
  const [justCompleted, setJustCompleted] = useState(new Set()); // 방금 작성 완료된 항목
          ...
          <div className="flex gap-2 w-fit">
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${filter === 'all'
                ? 'bg-[#47B5FF] text-white font-semibold'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 auto-rows-max items-start">
                      ...
                      <div className="flex-1 min-w-0 p-6 flex flex-col transition-all duration-500 ease-in-out">
                        ...
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-semibold text-lg">
                            <Link
                              to={item.type === 'anime' ? `/anime/${item.itemId}` : `/character/${item.itemId}`}
                              className="text-gray-900 hover:text-[#47B5FF] transition-colors hover:underline cursor-pointer"
                            >
                              {item.type === 'anime' ? (
                                language === 'ko' ? (
                                  <span>
                          ...
                          <p className="text-xs text-gray-500 mb-1">
                            ...
                            {item.anime_id ? (
                              <Link
                                ...
                                className="hover:text-[#47B5FF] hover:underline transition-colors"
                              >
                                {language === 'ko' ? (
                                  <>
                            ...
                            {hasReview ? (
                              <>
                                ...
                                <button
                                  ...
                                  className="text-sm text-[#47B5FF] hover:text-[#2DD4E4]"
                                >
                              ...
                              <button
                                ...
                                className="text-sm text-gray-500 border border-gray-300 px-4 py-2 rounded transition-all hover:bg-[#47B5FF] hover:text-white hover:border-[#47B5FF] group-hover:bg-[#47B5FF] group-hover:text-white group-hover:border-[#47B5FF]"
                              >
                          ...
                          <div className="space-y-3 animate-fadeIn">
                            ...
                            <div>
                              <label className="block text-sm text-gray-700 mb-2">
                                ...
                                <span className="text-xs text-gray-400 font-normal ml-1">
                                  {language === 'ko' ? '(클릭하여 수정 가능)' : language === 'ja' ? '(クリックして変更)' : '(Click to edit)'}
                                </span>
                              </label>
                              <StarRating
                                rating={editRating}
                            ...
                            <div className="flex gap-1.5 justify-end mt-1">
                              ...
                              <button
                                ...
                                style={{ backgroundColor: '#47B5FF', color: 'white' }}
            ...
            {loadingMore && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 mt-2">{language === 'ko' ? '더 불러오는 중...' : language === 'ja' ? '読込中...' : 'Loading more...'}</p>
              </div>
            )}
