    ...
    <div className="min-h-screen pt-10 md:pt-12 bg-transparent">
      <div className="max-w-[1180px] mx-auto px-3 sm:px-6 lg:px-8 py-4">
        <div className="flex gap-6">
          ...
          >
            <nav
              className="flex flex-col gap-1 fixed top-14 md:top-16 w-48"
              style={{ zIndex: 10 }}
            >
                <button
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <textarea
                      ...
                      className="w-full px-4 py-2 text-base md:text-[14px] border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 resize-none"
                      rows="2"
                    />
