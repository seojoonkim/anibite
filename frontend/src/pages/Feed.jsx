          ...
          >
            <nav className="sticky top-20 flex flex-col gap-2">
              <button
                ...
                style={feedFilter === 'all' ? { background: 'linear-gradient(135deg, #4EEAF7 0%, #2DD4E4 100%)' } : {}}
              >
              ...
              <button
                ...
                style={feedFilter === 'following' ? { background: 'linear-gradient(135deg, #4EEAF7 0%, #2DD4E4 100%)' } : {}}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <button
                ...
                style={feedFilter === 'notifications' ? { background: 'linear-gradient(135deg, #4EEAF7 0%, #2DD4E4 100%)' } : {}}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <button
                ...
                style={feedFilter === 'saved' ? { background: 'linear-gradient(135deg, #4EEAF7 0%, #2DD4E4 100%)' } : {}}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex justify-end mt-1.5">
                      <button
                        ...
                        style={newPostContent.trim() ? { background: 'linear-gradient(135deg, #4EEAF7 0%, #2DD4E4 100%)', fontWeight: '600' } : {}}
                      >
