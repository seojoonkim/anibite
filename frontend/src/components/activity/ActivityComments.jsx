          ...
          <div className="flex gap-2 items-start">
            ...
            <div className="flex-1 flex gap-2">
              ...
              <button
                ...
                style={newCommentText.trim() ? { backgroundColor: '#7FBFEF' } : {}}
              >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5 mb-0.5">
                      <Link
                        ...
                        className="text-[13px] font-medium text-gray-700 hover:text-[#7FBFEF]"
                      >
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      {currentUser && (
                        <button
                          ...
                          className="text-[11px] text-gray-500 hover:text-[#7FBFEF]"
                        >
                    ...
                    {replyingTo === comment.id && (
                      <div className="mt-1.5 flex gap-2">
                        ...
                        <button
                          ...
                          style={replyText.trim() ? { backgroundColor: '#7FBFEF' } : {}}
                        >
                          {language === 'ko' ? '작성' : language === 'ja' ? '作成' : 'Post'}
                        </button>
                        <button
